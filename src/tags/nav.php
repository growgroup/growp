...
class GNav
{
    ...
    public static function _paginate_links($args = '')
    {
        ...
        if ($args['prev_next'] && $current && 1 < $current) :
             ...
             */
            $page_links[] = '<li class="c-pagination__prev"><a class="prev page-numbers" href="' . esc_url(apply_filters('paginate_links',
        ...
        if ($args['prev_next'] && $current && ($current < $total || -1 == $total)) :
            ...
            /** This filter is documented in wp-includes/general-template.php */
            $page_links[] = '<li class="c-pagination__next"><a class="next page-numbers" href="' . esc_url(apply_filters('paginate_links',
