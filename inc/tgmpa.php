...
if ( class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	$config = array(
		...
		'dismiss_msg'  => __( 'Dismiss this notice', 'growp' ),                      // If 'dismissable' is false, this message will be output at top of nag.
		'is_automatic' => true,                   // Automatically activate plugins after installation or not.
		'message'      => '',                      // Message to output right before the plugins table.
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'growp' ),
			'menu_title'                      => __( 'Install Plugins', 'growp' ),
			'installing'                      => __( 'Installing Plugin: %s', 'growp' ), // %s = plugin name.
			...
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'growp' ),  // %1$s = plugin name(s).
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'growp' ),  // %1$s = plugin name(s).
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'growp' ), // %s = dashboard link.
